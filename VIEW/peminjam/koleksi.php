...
<body>
  <nav class="nav">
    ...
    <ul class="nav-links">
      ...
      <li><a href="koleksi.php" class="active">Koleksi</a></li>
    ...
    <div class="rekomendasi-bottom-container">
      ...
      ?>
        <div class="rekomendasi-card">
          <div class="card-gambar" style="background-image: url('<?php echo "../../assets/gambar/" . $book['gambar']; ?>');">
            <p class="rating"><?php echo $book['rata_rating']; ?>/5</p>
          </div>
          <div class="buku-text">
            <p class="penulis"><?php echo $book['penulis']; ?></p>
            <p><?php echo $book['judul']; ?></p>
            <p class="tahun"><?php echo $book['tahun_terbit']; ?></p>
            <p class="genre"><?php echo $book['nama_kategori']; ?></p>
          </div>
          <hr>
