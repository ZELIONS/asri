<?php
require_once 'C:/xampp/htdocs/backend/controller/Peminjam.php';
session_start();
...
$populer = $peminjam->TampilBukuPopuler($limit = 10);
        ...
        <div class="rekomendasi-container">
            <div class="rekomendasi-top-container">
                <div class="rekomendasi-judul-container">
                    <?php if (isset($query)) : ?>
                        <p>Hasil Pencarian untuk: <?php echo $query; ?> </p>
                    <?php endif; ?>
                </div>
            </div>
                    ...
                    <?php foreach ($cari_buku as $buku) : ?>
                        <a class="rekomendasi-card" href="detail-buku.php?id=<?php echo $buku['id']; ?>">
                            <div class="card-gambar" style="background-image: url('../../assets/gambar/<?php echo $buku['gambar']; ?>');">
                                <p class="rating"><?php echo $buku['rating']; ?>/5</p>
                            </div>
                            <div class="buku-text">
                                <p class="penulis"><?php echo $buku['penulis']; ?></p>
                                <p><?php echo $buku['judul']; ?></p>
                                <p class="tahun"><?php echo $buku['tahun_terbit']; ?></p>
                                <?php if (isset($buku['kategori_nama'])) : ?>
                                    <p class="genre"><?php echo $buku['kategori_nama']; ?></p>
                                <?php endif; ?>
                            </div>
                        </a>
                    <?php endforeach; ?>
            ...
            <div class="rekomendasi-top-container">
                <div class="rekomendasi-judul-container">
                    <?php if (isset($kategori_nama)) : ?>
                        <p>Hasil Pencarian untuk: <?php echo $kategori_nama; ?> </p>
                    <?php endif; ?>
                </div>
            </div>
    ...
    <div class="rekomendasi-container">
        ...
        <div class="rekomendasi-bottom-container">
            ...
            ?>
                <a class="rekomendasi-card" href="detail-buku.php?id=<?php echo $buku['id']; ?>">
                    <div class="card-gambar" style="background-image: url('../../assets/gambar/<?php echo $buku['gambar']; ?>');">
                        <p class="rating"><?php echo $buku['rating'] !== null ? $buku['rating'] . '/5' : 'Rating not available'; ?></p>
                    </div>
                    <div class="buku-text">
                        <p class="penulis"><?php echo $buku['penulis']; ?></p>
                        <p><?php echo $buku['judul']; ?></p>
                        <p class="tahun"><?php echo $buku['tahun_terbit']; ?></p>
                        <p class="genre"><?php echo $buku['nama_kategori']; ?></p>
                    </div>
                </a>
            <?php
            }
        ...
        <div class="comment-box gradient-bg">
            ...
            <form action="" method="post" name="masukan">
                <div class="form-group">
                    ...
                    <textarea id="comment" name="masukan" placeholder="ketik Komentar Anda Disini"></textarea>
                </div>
