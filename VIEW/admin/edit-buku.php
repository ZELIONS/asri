...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['gambar'])) {
    $judul = $_POST['judul'];
    ...
    $gambar = $_POST['gambar'];
    $admin->EditBuku($id_buku, $judul, $penulis, $penerbit, $tahun, $sinopsis, $nama_kategori, $bahasa, $jumlah_halaman, $gambar);
