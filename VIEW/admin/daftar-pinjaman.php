        ...
        <?php foreach ($buku_pinjaman as $buku) : ?>
            ...
            <div class="card-container">
                ...
                <div class="card-container-tengah">
                    ...
                    <p><?php echo $buku['username_peminjam']; ?></p>
                    <p>Tanggal Pinjam: <?php echo $buku['tanggal_peminjaman']; ?></p>
                    <p>Batas Waktu: <?php echo $buku['tanggal_pengembalian']; ?></p>
                </div>

                <div class="card-container-bawah">
                    <button class="button"><a href="?id=<?php echo $buku['id']; ?>" style="text-decoration:none">Sudah Dikembalikan</a></button>
                </div>
            </div>
        <?php endforeach; ?>
