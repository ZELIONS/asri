<?php
session_start();
require_once 'C:/xampp/htdocs/backend/controller/Masuk.php';
require_once 'C:/xampp/htdocs/backend/controller/Daftar.php';
...
<head>
    <meta charset="UTF-8">
    <title>Animated Login Form with Changing Background</title>
